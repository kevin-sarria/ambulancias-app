...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $query_2 = "DELETE FROM `links_kilometraje` WHERE id=$id_link_kilometraje";
    ...
    <div class="centrar">
        <form method="POST">
            ...
            <div class="grid-2-column">
                <a href="<?php echo $carpeta_vistas . 'links_kilometraje.php?id=' . $id_ambulancia ?>" class="botones btn_amarillo">Cancelar</a>
